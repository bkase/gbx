...
/// Address space describing a debug memory window.
#[derive(Debug, Clone, PartialEq, Eq, Archive, Serialize)]
#[rkyv(
    attr(
        allow(missing_docs),
        doc = "Archived representation of `KernelDebugMemSpaceV1`."
    ),
    bytecheck()
)]
pub enum KernelDebugMemSpaceV1 {
...
/// CPU snapshot payload for debug snapshots.
#[derive(Debug, Clone, PartialEq, Eq, Archive, Serialize)]
#[rkyv(
    attr(
        allow(missing_docs),
        doc = "Archived representation of `KernelDebugCpuVmV1`."
    ),
    bytecheck()
)]
pub struct KernelDebugCpuVmV1 {
    pub a: u8,
    pub f: u8,
    pub b: u8,
    pub c: u8,
...
/// PPU snapshot payload for debug snapshots.
#[derive(Debug, Clone, PartialEq, Eq, Archive, Serialize)]
#[rkyv(
    attr(
        allow(missing_docs),
        doc = "Archived representation of `KernelDebugPpuVmV1`."
    ),
    bytecheck()
)]
pub struct KernelDebugPpuVmV1 {
    pub ly: u8,
    pub mode: u8,
    pub stat: u8,
    pub lcdc: u8,
...
/// Timer snapshot payload for debug snapshots.
#[derive(Debug, Clone, PartialEq, Eq, Archive, Serialize)]
#[rkyv(
    attr(
        allow(missing_docs),
        doc = "Archived representation of `KernelDebugTimersVmV1`."
    ),
    bytecheck()
)]
pub struct KernelDebugTimersVmV1 {
    pub div: u8,
    pub tima: u8,
    pub tma: u8,
    pub tac: u8,
...
/// Snapshot payload emitted by debug reports.
#[derive(Debug, Clone, PartialEq, Eq, Archive, Serialize)]
#[rkyv(
    attr(
        allow(missing_docs),
        doc = "Archived representation of `KernelDebugSnapshotV1`."
    ),
    bytecheck()
)]
pub struct KernelDebugSnapshotV1 {
    pub cpu: KernelDebugCpuVmV1,
    pub ppu: KernelDebugPpuVmV1,
    pub timers: KernelDebugTimersVmV1,
    pub io: Vec<u8>,
}

/// Step kind enumeration for debug stepping.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Archive, Serialize)]
#[rkyv(
    attr(
        allow(missing_docs),
        doc = "Archived representation of `KernelDebugStepKindV1`."
    ),
    bytecheck()
)]
pub enum KernelDebugStepKindV1 {
    Instruction,
    Frame,
}

/// Debug command variants sent to the kernel.
#[derive(Debug, Clone, PartialEq, Eq, Archive, Serialize)]
#[rkyv(
    attr(
        allow(missing_docs),
        doc = "Archived representation of `KernelDebugCmdV1`."
    ),
    bytecheck()
)]
pub enum KernelDebugCmdV1 {
    Snapshot {
        group: u16,
    },
    MemWindow {
        group: u16,
        space: KernelDebugMemSpaceV1,
        base: u16,
        len: u16,
    },
    StepInstruction {
...
/// Debug report variants generated by the kernel.
#[derive(Debug, Clone, PartialEq, Eq, Archive, Serialize)]
#[rkyv(
    attr(
        allow(missing_docs),
        doc = "Archived representation of `KernelDebugRepV1`."
    ),
    bytecheck()
)]
pub enum KernelDebugRepV1 {
    Snapshot(KernelDebugSnapshotV1),
    MemWindow {
        space: KernelDebugMemSpaceV1,
        base: u16,
        bytes: Vec<u8>,
...
pub enum KernelCmdV1 {
    ...
    /// Execute a debug/inspector command.
    Debug(KernelDebugCmdV1),
}
